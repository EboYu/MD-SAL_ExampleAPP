...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final String name = "exampleapp";
    private final String namespace = "urn:opendaylight:params:xml:ns:yang:exampleapp:api";
    private final String revision = "2016-03-28";
    private final String resourcePath = "/META-INF/yang/exampleapp.yang";

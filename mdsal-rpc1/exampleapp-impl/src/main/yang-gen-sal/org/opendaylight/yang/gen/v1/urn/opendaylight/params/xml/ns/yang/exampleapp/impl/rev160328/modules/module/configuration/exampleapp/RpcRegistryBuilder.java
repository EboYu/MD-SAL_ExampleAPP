package org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp;
...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry
 *
 */
public class RpcRegistryBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry> {
    ...
    public RpcRegistryBuilder(RpcRegistry base) {
        ...
        if (base instanceof RpcRegistryImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public RpcRegistryBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry> augmentation) {
    ...
    public RpcRegistryBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class RpcRegistryImpl implements RpcRegistry {
        ...
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry other = (org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.RpcRegistry)obj;

...
/**
 * Class that builds {@link org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker} instances.
 *
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker
 *
 */
public class BrokerBuilder implements Builder <org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker> {
    ...
    public BrokerBuilder(Broker base) {
        ...
        if (base instanceof BrokerImpl) {
            ...
            AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker> casted =(AugmentationHolder<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker>) base;
    ...
    */
    ...
    @SuppressWarnings("unchecked")
    public <E extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker>> E getAugmentation(java.lang.Class<E> augmentationType) {
    ...
    public BrokerBuilder addAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker>> augmentationType, Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker> augmentation) {
    ...
    public BrokerBuilder removeAugmentation(java.lang.Class<? extends Augmentation<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker>> augmentationType) {
        if (this.augmentation instanceof HashMap) {
    ...
    private static final class BrokerImpl implements Broker {
        ...
        public java.lang.Class<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker> getImplementedInterface() {
            return org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker.class;
        }
        ...
        public boolean equals(java.lang.Object obj) {
            ...
            if (!org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker.class.equals(((DataObject)obj).getImplementedInterface())) {
                return false;
            }
            org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker other = (org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.exampleapp.impl.rev160328.modules.module.configuration.exampleapp.Broker)obj;
